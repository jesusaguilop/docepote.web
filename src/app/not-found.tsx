...
export default function NotFound() {
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center px-6 py-20 text-center">
      ...
      <p className="mt-8 font-script text-5xl text-green-deep">Uy...</p>
      <h1 className="mt-3 font-display text-2xl font-bold">Este pote no existe</h1>
      <p className="mt-3 max-w-[38ch] text-[0.98rem] leading-relaxed text-ink-soft">
        La página que buscas se acabó o nunca estuvo en el mostrador. Vuelve al catálogo, que
        ahí siempre hay algo recién hecho.
      </p>
